      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        ...
        <div className="flex space-x-3">
          <button
            ...
            className="bg-indigo-600  dark:bg-indigo-500  dark:hover:bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 transition flex items-center"
          >
          ...
          <button
            ...
            className="bg-gray-600  dark:bg-indigo-500  dark:hover:bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition flex items-center"
          >
